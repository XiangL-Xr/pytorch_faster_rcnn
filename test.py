...
def parse_args():
  ...
  parser.add_argument('--load_path', dest='load_path',
                      help='path to load pretrained models', default="./checkpoints/vgg16_caffe.pth",
                      type=str)
...
if __name__ == '__main__':
  ...
  if not os.path.exists(args.load_path):
    raise Exception('There is no input directory for loading network from ' + args.load_path)
